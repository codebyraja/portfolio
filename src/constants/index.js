...
const experiences = [
  ...
  // },
  {
    ...
    company_name: "Logical Learning Company Pvt. Ltd.",
    icon: llc,
    iconBg: "#E6DEDD",
    date: "Apr 2025 - Present",
    points: [
      "Developed and maintained web applications using React (Frontend) and .NET Core Web API (Backend).",
      "Designed and optimized relational databases using SQL Server.",
      "Implemented secure, scalable RESTful APIs and integrated third-party services.",
      "Deployed and hosted applications on Microsoft Windows Server, managing IIS, security, and server configurations.",
      "Ensured responsive UI/UX, performance optimization, and cross-browser compatibility.",
      "Version control using Git, collaborative development, and Agile methodologies.",
      "Hands-on knowledge of system administration, CI/CD, and application lifecycle management.",
    ],
  },
  {
    title: "Full Stack Web Developer",
  ...
  },
  {
    ...
    company_name: "Valencia Facility Services LLP",
    icon: vfs,
    iconBg: "#E6DEDD",
    date: "Dec 2020 - Jul 2022",
    points: [
      "Provided technical and administrative support to clients and internal staff from the back office.",
      "Handled queries via calls, emails, and ticketing systems.",
      "Performed data entry, maintained records, and prepared daily/weekly reports.",
      "Coordinated with different departments to resolve issues efficiently.",
      "Monitored system updates and performed basic troubleshooting.",
